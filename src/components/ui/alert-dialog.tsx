...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-3 sm:flex-row sm:justify-center sm:gap-4",
        className
      )}
      {...props}
    />
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(
        ...
        "min-w-[100px] text-muted-foreground hover:text-foreground",
        className
      )}
      {...props}
    />
