...
export function CodeBlockElement(props: PlateElementProps<TCodeBlockElement>) {
  ...
  return (
    <PlateElement
      ...
      {...props}
    >
      <div className="relative rounded-md bg-muted/50 transition-all hover:bg-muted/70 hover:ring-2 hover:ring-muted-foreground/20">
        <pre className="overflow-x-auto p-8 pr-4 font-mono text-sm leading-[normal] [tab-size:2] print:break-inside-avoid cursor-text">
