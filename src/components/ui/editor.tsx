...
const editorContainerVariants = cva(
  'relative w-full min-w-0 cursor-text caret-primary select-text selection:bg-brand/25 focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-brand/25 [&_.slate-selection-area]:bg-brand/15',
  {
    defaultVariants: {
      variant: 'default',
    },
...
const editorVariants = cva(
  cn(
    'group/editor',
    'relative cursor-text overflow-x-hidden min-w-0 break-words whitespace-pre-wrap select-text',
